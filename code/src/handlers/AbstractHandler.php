...
Чтобы добавить запись для напоминания, перед сообщением необходимо указать команду _/add_
Например: _/add Моя новая запись_
        
*Настройка уведомлений*
Отправьте сообщение _Записи_, либо нажмите соответствующую кнопку. Выберите необходимую запись.
Далее необходимо выбрать день, для которого установить время уведомления. Обратите внимание, что можно установить сразу несколько временных меток.
Если выбрать _Все дни_, _Будни_ или _Выходные_, то временные метки установятся для соответствующих дней.
        ";
